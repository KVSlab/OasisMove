...
def assemble_first_inner_iter(A, a_conv, bw0, bw_tmp, dt, M, scalar_components, les_model, nn_model, a_scalar, K, nu,
                              nut_, nunn_, u_components, LT, KT, NT, b_tmp, b0, x_1, wx_, x_2, u_ab, bcs,
                              **NS_namespace):
